...
static constexpr char* DEFAULT_THEME_NAME = (char*)"default_light";
...
namespace modui
{
	...
	namespace utils
	{
		...
		static inline unsigned mix(unsigned col1, unsigned col2, float factor) { return (col2 - col1) * factor + col1; }
